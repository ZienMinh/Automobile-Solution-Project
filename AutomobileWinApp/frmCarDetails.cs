    ...
    public partial class frmCarDetails : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                var car = new Car
                {
                    CarID = int.Parse(txtCarID.Text.ToString()),
                    CarName = txtCarName.Text.ToString(),
                    Manufacturer = cboManufacturer.Text.ToString(),
                    Price = decimal.Parse(txtPrice.Text.ToString()),
                    ReleaseYear = int.Parse(txtReleaseYear.Text.ToString())
                };
